  ...
  return (
    <>
      ...
      <div className="max-w-sm sm:max-w-none block p-2 bg-secondary-1 mb-5 sm:mb-10">
        <ul className="justify-center sm:flex sm:flex-wrap sm:space-between">

        {/* Day Pass */}
          <li className="block bg-primary-1 p-6 text-maintext mt-1 sm:mt-0 mb-3 sm:mb-0 mx-2 w-full sm:w-1/4 border-2 border-secondary-1 hover:border-4 hover:border-highlight-1">
            <div>
          ...
          {/* Concession */}
          <li className="block bg-primary-1 p-6 text-maintext mb-3 sm:mb-0 mx-2 w-full sm:w-1/4 border-2 border-secondary-1 hover:border-4 hover:border-highlight-1">
          ...
          {/* Band */}
          <li className="block bg-primary-1 p-6 text-maintext mb-1 sm:mb-0  mx-2 w-full sm:w-1/4 border-2 border-secondary-1 hover:border-4 hover:border-highlight-1">

      ...
      <div className="mb-5 sm:mb-10 sm:max-w-xl mx-auto">
        ...
        <ul className="sm:flex justify-center">
          ...
          <li className="block max-w-xs mb-2 mx-auto text-center w-100 sm:flex-grow sm:inline-block sm:mb-0 sm:mr-2 sm:w-1/2">
            {/* Button */}
            <a
              className="block buttonhover p-2 bg-secondary-1 hover:bg-secondary-3 focus:bg-secondary-3 text-highlight-1 hover:text-highlight-1 font-semibold plausible-event-name=Webcam+Button"
          ...
          <li className="block max-w-xs mb-2 mx-auto text-center w-100 sm:flex-grow sm:inline-block sm:mb-0 sm:mr-0 sm:w-1/2">
            ...
            <a
              className="block buttonhover p-2 bg-secondary-1 hover:bg-secondary-3 focus:bg-secondary-3 text-highlight-1 hover:text-highlight-1 font-semibold plausible-event-name=Wiki+Button"
